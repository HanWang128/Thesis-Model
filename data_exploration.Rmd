...
11. transit_stations:  number of visitors to transit stations has changed compared to baseline days (baseline: median value for the 5‑week period from January 3 to February 6, 2020)
...
From the trend plot, the stringency, residential, and hospital admission have similar trend, we think that the stringency （lockdowns policy, restrictions of going out） has effect the variable Residential. Then either people can not going out then reduce the number of patients in the hospital, or the spread of virus is less that reduce the number of patients in the hospital.


summer low COVID, winter high COVID
also humidity related to hospital admission and ICU, not a clear trend is shown for wind speed
...
# change temp, humidity, wind speed and precipitation to categorical variables, and observe the relations
```{r}
data_cat=data
